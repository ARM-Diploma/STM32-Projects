...
/******************************************************************************/
#define AI_TEST1_MODEL_NAME          "test1"
#define AI_TEST1_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_TEST1_ACTIVATIONS_ALIGNMENT   (4)
#define AI_TEST1_INPUTS_IN_ACTIVATIONS   (4)
#define AI_TEST1_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_TEST1_IN_NUM        (1)

AI_DEPRECATED
//#define AI_TEST1_IN \ ai_test1_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_TEST1_IN_SIZE { \
  AI_TEST1_IN_1_SIZE, \
}
#define AI_TEST1_IN_SIZE_BYTES { \
  AI_TEST1_IN_1_SIZE_BYTES, \
}
#define AI_TEST1_IN_1_CHANNEL     (6)
#define AI_TEST1_IN_1_SIZE        (6)
#define AI_TEST1_IN_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_TEST1_OUT_NUM       (2)

AI_DEPRECATED
#define AI_TEST1_OUT {\
  ai_test1_outputs_get(AI_HANDLE_NULL, NULL),\
}
#define AI_TEST1_OUT_SIZE { \
  AI_TEST1_OUT_1_SIZE, \
}
#define AI_TEST1_OUT_SIZE_BYTES { \
  AI_TEST1_OUT_1_SIZE_BYTES, \
}
#define AI_TEST1_OUT_1_CHANNEL     (1)
#define AI_TEST1_OUT_1_SIZE        (1)
#define AI_TEST1_OUT_1_SIZE_BYTES  (4)


#define AI_TEST1_OUT_2_CHANNEL     (1)
#define AI_TEST1_OUT_2_SIZE        (1)
#define AI_TEST1_OUT_2_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_TEST1_N_NODES (10)
 ...
 * @ref ai_test1_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_test1_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_TEST1_*
 * defines into file @ref test1.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
