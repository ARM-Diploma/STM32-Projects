...
AI_ALIGNED(32)
static uint8_t pool0[AI_TEST1_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_TEST1_MODEL_NAME,
        .config = AI_TEST1_DATA_CONFIG,
        .ai_get_report = ai_test1_get_report,
        .ai_create = ai_test1_create,
        .ai_destroy = ai_test1_destroy,
        .ai_get_error = ai_test1_get_error,
        .ai_init = ai_test1_init,
        .ai_run = ai_test1_run,
        .ai_forward = ai_test1_forward,
        .ai_data_params_get = ai_test1_data_params_get,
