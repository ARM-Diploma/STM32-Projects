...
#define AI_SINE_MODEL_MODEL_SIGNATURE     "2aea94e71d415d50116540a15613874f"
...
#define AI_TOOLS_DATE_TIME   "Wed May 10 04:58:42 2023"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    1624, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_MODEL_IN_NUM, &serving_default_L1_input0_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_SINE_MODEL_OUT_NUM, &nl_2_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_sine_model_weights_map, 1, params)) {
    ...
    dense_0_weights_array.data = AI_PTR(g_sine_model_weights_map[0] + 1024);
    dense_0_weights_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 0);
    
    dense_0_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_0_bias_array.data = AI_PTR(g_sine_model_weights_map[0] + 3424);
    dense_0_bias_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 3424);
    
    dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_weights_array.data = AI_PTR(g_sine_model_weights_map[0] + 5024);
    dense_1_weights_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 5024);
    
    dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_bias_array.data = AI_PTR(g_sine_model_weights_map[0] + 6624);
    dense_1_bias_array.data_start = AI_PTR(g_sine_model_weights_map[0] + 6624);
