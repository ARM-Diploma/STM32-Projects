...
#include "test3_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_TEST3_MODEL_NAME          "test3"
#define AI_TEST3_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_TEST3_ACTIVATIONS_ALIGNMENT   (4)
#define AI_TEST3_INPUTS_IN_ACTIVATIONS   (4)
#define AI_TEST3_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_TEST3_IN_NUM        (1)

AI_DEPRECATED
#define AI_TEST3_IN \
  ai_test3_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_TEST3_IN_SIZE { \
  AI_TEST3_IN_1_SIZE, \
}
#define AI_TEST3_IN_SIZE_BYTES { \
  AI_TEST3_IN_1_SIZE_BYTES, \
}
#define AI_TEST3_IN_1_CHANNEL     (6)
#define AI_TEST3_IN_1_SIZE        (6)
#define AI_TEST3_IN_1_SIZE_BYTES  (24)

/******************************************************************************/
#define AI_TEST3_OUT_NUM       (1)

AI_DEPRECATED
#define AI_TEST3_OUT \
  ai_test3_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_TEST3_OUT_SIZE { \
  AI_TEST3_OUT_1_SIZE, \
}
#define AI_TEST3_OUT_SIZE_BYTES { \
  AI_TEST3_OUT_1_SIZE_BYTES, \
}
#define AI_TEST3_OUT_1_CHANNEL     (1)
#define AI_TEST3_OUT_1_SIZE        (1)
#define AI_TEST3_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_TEST3_N_NODES (4)
 ...
 * @ref ai_test3_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_buffer* ai_test3_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_TEST3_*
 * defines into file @ref test3.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
