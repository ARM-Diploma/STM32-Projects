...
#define AI_SINE_MODEL_ORIGIN_MODEL_NAME   "model"
...
#define AI_SINE_MODEL_IN_1_CHANNEL     (6)
#define AI_SINE_MODEL_IN_1_SIZE        (6)
#define AI_SINE_MODEL_IN_1_SIZE_BYTES  (24)
